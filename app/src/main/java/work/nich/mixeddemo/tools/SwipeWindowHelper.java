...
public class SwipeWindowHelper extends Handler {
    ...
    private int getWindowBackgroundColor() {
        ...
        try {
            array = getContext().getTheme()
                .obtainStyledAttributes(new int[]{android.R.attr.windowBackground});
            return array.getColor(0, getContext().getResources().getColor(R.color.transparent));
        } finally {
            if (array != null) {
                array.recycle();
            }
    ...
    class ViewManager {
        ...
        private boolean addViewFromPreviousActivity() {
            ...
            MixedApplication application = (MixedApplication) mCurrentWindow.getContext()
